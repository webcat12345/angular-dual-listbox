(function (global, factory) {
	...
	(factory((global['angular-dual-listbox'] = global['angular-dual-listbox'] || {}),global._angular_core,global._angular_common,global._angular_forms));
...
exports.DualListComponent = DualListComponent_1 = (function () {
    function DualListComponent(differs) {
        ...
        this.format = typeof this.format !== 'undefined' ? this.format : DualListComponent_1.DEFAULT_FORMAT;
        this.sort = typeof this.sort !== 'undefined' ? this.sort : false;
        this.compare = typeof this.compare !== 'undefined' ? this.compare : undefined;
        this.destinationChange = new _angular_core.EventEmitter();
        this.editItem = new _angular_core.EventEmitter();
        this.sorter = function (a, b) { return (a._name < b._name) ? -1 : ((a._name > b._name) ? 1 : 0); };
        this.available = new BasicList(DualListComponent_1.AVAILABLE_LIST_NAME);
        this.confirmed = new BasicList(DualListComponent_1.CONFIRMED_LIST_NAME);
    }
    DualListComponent.prototype.ngOnChanges = function (changeRecord) {
        ...
        if (changeRecord['format']) {
            ...
            if (typeof (this.format.direction) === 'undefined') {
                this.format.direction = DualListComponent_1.LTR;
            }
            if (typeof (this.format.add) === 'undefined') {
                this.format.add = DualListComponent_1.DEFAULT_FORMAT.add;
            }
            if (typeof (this.format.remove) === 'undefined') {
                this.format.remove = DualListComponent_1.DEFAULT_FORMAT.remove;
            }
            if (typeof (this.format.all) === 'undefined') {
                this.format.all = DualListComponent_1.DEFAULT_FORMAT.all;
            }
            if (typeof (this.format.none) === 'undefined') {
                this.format.none = DualListComponent_1.DEFAULT_FORMAT.none;
            }
        }
        ...
        if (sourceChanges) {
            ...
            sourceChanges.forEachAddedItem(function (r) {
                if (_this.findItemIndex(_this.available.list, r.item, _this.key) === -1) {
                    _this.available.list.push({ _id: _this.makeId(r.item), _name: _this.makeName(r.item), target: r.item });
                }
            });
    ...
    DualListComponent.prototype.direction = function () {
        return this.format.direction === DualListComponent_1.LTR;
    };
...
exports.DualListComponent.AVAILABLE_LIST_NAME = 'available';
exports.DualListComponent.CONFIRMED_LIST_NAME = 'confirmed';
exports.DualListComponent.LTR = 'left-to-right';
exports.DualListComponent.RTL = 'right-to-left';
exports.DualListComponent.DEFAULT_FORMAT = { add: 'Add', remove: 'Remove', all: 'All', none: 'None', direction: DualListComponent_1.LTR };
__decorate([
    _angular_core.Input(),
    __metadata("design:type", String)
], exports.DualListComponent.prototype, "key", void 0);
__decorate([
    _angular_core.Input(),
    __metadata("design:type", String)
], exports.DualListComponent.prototype, "display", void 0);
__decorate([
    _angular_core.Input(),
    __metadata("design:type", String)
], exports.DualListComponent.prototype, "height", void 0);
__decorate([
    _angular_core.Input(),
    __metadata("design:type", Boolean)
], exports.DualListComponent.prototype, "filter", void 0);
__decorate([
    _angular_core.Input(),
    __metadata("design:type", Object)
], exports.DualListComponent.prototype, "format", void 0);
__decorate([
    _angular_core.Input(),
    __metadata("design:type", Boolean)
], exports.DualListComponent.prototype, "sort", void 0);
__decorate([
    _angular_core.Input(),
    __metadata("design:type", Function)
], exports.DualListComponent.prototype, "compare", void 0);
__decorate([
    _angular_core.Input(),
    __metadata("design:type", Array)
], exports.DualListComponent.prototype, "source", void 0);
__decorate([
    _angular_core.Input(),
    __metadata("design:type", Array)
], exports.DualListComponent.prototype, "destination", void 0);
__decorate([
    _angular_core.Input(),
    __metadata("design:type", Boolean)
], exports.DualListComponent.prototype, "editRight", void 0);
__decorate([
    _angular_core.Input(),
    __metadata("design:type", Boolean)
], exports.DualListComponent.prototype, "editLeft", void 0);
__decorate([
    _angular_core.Input(),
    __metadata("design:type", String)
], exports.DualListComponent.prototype, "tooltipProperty", void 0);
__decorate([
    _angular_core.Output(),
    __metadata("design:type", Object)
], exports.DualListComponent.prototype, "destinationChange", void 0);
__decorate([
    _angular_core.Output(),
    __metadata("design:type", Object)
], exports.DualListComponent.prototype, "editItem", void 0);
exports.DualListComponent = DualListComponent_1 = __decorate([
...
exports.AngularDualListBoxModule = (function () {
    function AngularDualListBoxModule() {
    }
    return AngularDualListBoxModule;
}());
exports.AngularDualListBoxModule = __decorate$1([
    _angular_core.NgModule({
        imports: [
            _angular_common.CommonModule,
            _angular_forms.FormsModule
        ],
        declarations: [exports.DualListComponent],
        exports: [exports.DualListComponent]
    })
], exports.AngularDualListBoxModule);
